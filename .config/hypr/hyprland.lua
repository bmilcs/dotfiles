...
local appMenu     = "rofi -show combi -combi-modi 'window,drun,ssh' -modi combi"
...
-- move focused window
hl.bind(mainMod .. " + " .. triMod .. " + H", hl.dsp.window.move({direction = "left"}))
hl.bind(mainMod .. " + " .. triMod .. " + L", hl.dsp.window.move({direction = "right"}))
hl.bind(mainMod .. " + " .. triMod .. " + K", hl.dsp.window.move({direction = "right"}))
hl.bind(mainMod .. " + " .. triMod .. " + J", hl.dsp.window.move({direction = "down"}))
